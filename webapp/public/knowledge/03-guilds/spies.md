...
> **Draft in progress.** This article is a scaffold. Some sections are filled with placeholders until the full write-up lands. If you have first-hand info, corrections or screenshots, share them in `#feedback` or via the in-app Contact form.

The Spies Guild trains operators of subtlety: information gathering, stealth, infiltration and the soft pressure that decides battles before they start.
...
This page exists so the table of contents has the right shape for the alpha. Real content lands as the guild systems are documented.
